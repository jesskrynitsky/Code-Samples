// Jessica Krynitsky / 03/02/18 / jmk8vr / AVLTree.h
...
class AVLTree {
 ...
 private:
  ...
  string pathTo(const string& x, AVLNode * const &curnode) const;
  bool find(const string& x, AVLNode * const &curnode) const;
  int numNodes(AVLNode * const &node) const;

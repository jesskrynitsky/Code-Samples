...
/** @brief Prints out the number of cities in the world and their names.
 */
 ...
 * cities passed in does not include this start/end point (so there
 * will be length+1 entries in the returned vector).
 * @param length The number of cities to travel to, not including the start and end point.
 */
